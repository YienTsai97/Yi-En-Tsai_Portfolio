...
const tabIcons: Record<ExperienceGroup['id'], string> = {
  education:
...
const tabViewBoxes: Record<ExperienceGroup['id'], string> = {
  education: '0 0 640 512',
  work: '0 0 512 512',
  volunteer: '0 0 640 512'
}
  ...
  <div class="experience-tabs">
    ...
    >
      <button
        ...
        type="button"
        role="tab"
        class="experience-tabs__trigger"
      ...
      >
        <svg
          class="experience-tabs__icon"
          xmlns="http://www.w3.org/2000/svg"
          :viewBox="tabViewBoxes[group.id]"
          aria-hidden="true"
          focusable="false"
        >
          <path :d="tabIcons[group.id]" />
        </svg>
        {{ group.label }}
      </button>
    </div>
